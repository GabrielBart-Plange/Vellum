...
export default function Sidebar() {
  return (
    <aside className="w-56 glass-panel border-r border-[var(--reader-border)] p-6 h-full flex flex-col">
      <h2 className="tracking-[0.2em] text-[10px] font-semibold text-[var(--reader-text-muted)] flex items-center gap-3 mb-10 overflow-hidden whitespace-nowrap">
      ...
      <div className="mt-auto pt-8">
        <div className="p-4 rounded-xl bg-[var(--reader-surface)] border border-[var(--reader-border)] space-y-2">
          <p className="text-[10px] text-[var(--reader-text-subtle)] leading-relaxed italic">
